...
fn run_app(daemon: bool) {
    ...
    let mut app = builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            haider_rpc_ade::branch_create,
            haider_rpc_ade::session_fork_with_prompt,
            haider_rpc_ade::run_retry,
            haider_rpc_ade::headless_run_start,
            haider_rpc_ade::headless_run_status,
            haider_rpc_ade::headless_run_stop,
            haider_rpc_ade::session_fleet,
            haider_rpc_ade::status_snapshot,
            haider_rpc_ade::agent_message,
            haider_rpc_ade::agent_cancel,
            ...
            haider_rpc_ade::peer_list,
            haider_rpc_ade::peer_send,
            haider_rpc_ade::peer_name,
            haider_rpc_ade::shell_list,
            haider_rpc_ade::shell_close,
            haider_rpc_ade::shell_exec,
            haider_rpc_ade::ssh_list,
            haider_rpc_ade::ssh_add,
            haider_rpc_ade::ssh_update,
            haider_rpc_ade::ssh_remove,
            haider_rpc_ade::ssh_test,
            haider_rpc_ade::ssh_shell,
            haider_rpc_ade::ssh_set_session_scope,
            haider_rpc_ade::ssh_shell_open,
            haider_rpc_ade::ssh_shell_input,
            haider_rpc_ade::ssh_shell_resize,
            haider_rpc_ade::ssh_shell_eof,
            haider_rpc_ade::checkpoint_list,
            haider_rpc_ade::checkpoint_undo,
            haider_rpc_ade::checkpoint_redo,
            haider_rpc_ade::checkpoint_rollback_turn,
            haider_rpc_ade::tools_inventory,
            haider_rpc_ade::hooks_list,
            haider_rpc_ade::hooks_trust,
            haider_rpc_ade::hooks_revoke,
            haider_rpc_ade::provider_configure,
            haider_rpc_ade::provider_remove,
            haider_rpc_ade::provider_set_trust,
            haider_rpc_ade::lockdown_status,
            haider_rpc_ade::lockdown_set_quota,
            haider_rpc_ade::account_refresh,
            haider_rpc_ade::loom_list,
            haider_rpc_ade::loom_validate,
            haider_rpc_ade::loom_author_draft,
            haider_rpc_ade::loom_author_revise,
            haider_rpc_ade::loom_author_confirm,
            haider_rpc_ade::loom_archive,
            haider_rpc_ade::loom_unarchive,
            haider_rpc_ade::loom_watch,
            haider_rpc_ade::loom_register_agent_type,
            haider_rpc_ade::loom_install_status,
            haider_rpc_ade::loom_install_retry,
            haider_rpc_ade::loom_install_cancel,
            haider_rpc_ade::loom_install_watch,
            haider_rpc_ade::session_select_agent_type,
            haider_rpc_ade::workflow_instance_get,
            haider_rpc_ade::graph_status,
            haider_rpc_ade::graph_inspect,
            haider_rpc_ade::graph_pin,
            haider_rpc_ade::graph_switch,
            haider_rpc_ade::graph_abandon,
            haider_rpc_ade::graph_run_set_open,
            haider_rpc_ade::loom_register_workflow,
            ...
            haider_rpc_ade::transcription_secret_get,
            haider_rpc_ade::transcription_secret_set,
