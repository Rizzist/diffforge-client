...
impl TerminalCoordinationContext {
    ...
    pub fn env_vars(&self) -> Vec<(String, String)> {
        ...
        let cwd_policy = if self.enforcement_mode == "worktree_required" {
            "visible_project_root_with_routed_worktree_writes"
        } else {
