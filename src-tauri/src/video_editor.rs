...
fn video_mcp_generate_models(kind: Option<&str>) -> Vec<serde_json::Value> {
    ...
    let rows = vec![
        ...
        serde_json::json!({"id":"seedance_2_0","kind":"video","name":"Seedance 2.0","caps":{"durations":[4,5,8,10,12],"resolutions":["480p","720p","1080p"],"aspects":["16:9","9:16","1:1","4:3"],"maxReferenceImages":4},"estUsdPerSecond":0.05}),
