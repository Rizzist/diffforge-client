...
export const WorkspaceLifecycleButton = styled(WorkspaceSettingsButton)`
  ...
  /* Tighter than the settings gear: shrink the box 24 -> 22 so the (unchanged
     14px) cross sits ~1px closer to each edge — less empty space per side. */
  width: 22px;
  height: 22px;
...
export const AudioTabBar = styled.div`
  ...
  ${AudioHeroRow} ${VaultPlaceholderIcon} {
    width: 30px;
    height: 30px;
...
export const AudioTabButton = styled.button`
  ...
  &[aria-selected="true"] {
    ...
    box-shadow:
      ...
      0 5px 14px rgba(var(--audio-accent-rgb, var(--forge-tint-rgb)), 0.06);
  }
...
export const NetworkingTitleRow = styled.div`
  display: flex;
  min-width: 0;
  align-items: baseline;
  gap: 10px;
...
export const NetworkingContractTag = styled.code`
  flex: 0 0 auto;
  overflow: hidden;
  max-width: 220px;
  padding: 3px 8px;
...
export const NetworkingHero = styled.div`
  display: flex;
  min-width: 0;
  align-items: center;
  justify-content: space-between;
  ...
  border-radius: 12px;
  background:
    linear-gradient(120deg, rgba(96, 165, 250, 0.05), transparent 55%),
    rgba(2, 6, 23, 0.5);

  &[data-state="live"] {
    border-color: rgba(60, 203, 127, 0.22);
    background:
      linear-gradient(120deg, rgba(60, 203, 127, 0.07), transparent 55%),
      rgba(2, 6, 23, 0.5);
  }
  ...
  &[data-state="offline"] {
    border-color: rgba(148, 163, 184, 0.2);
    background:
      linear-gradient(120deg, rgba(148, 163, 184, 0.06), transparent 55%),
      rgba(2, 6, 23, 0.5);
  }
...
export const NetworkingHeroState = styled.div`
  display: flex;
  min-width: 0;
  align-items: center;
  gap: 12px;
...
export const NetworkingHeroCopy = styled.div`
  display: grid;
  min-width: 0;
  gap: 3px;
...
export const NetworkingHeroStats = styled.div`
  display: flex;
  flex: 0 0 auto;
  align-items: stretch;
...
export const NetworkingHeroStat = styled.div`
  display: grid;
  align-content: center;
  gap: 5px;
  min-width: 74px;
...
export const NetworkingChannelGrid = styled.div`
  display: grid;
...
export const NetworkingChannel = styled.section`
  position: relative;
  display: grid;
  grid-template-rows: auto minmax(0, 1fr);
  min-width: 0;
  ...
  &[data-direction="down"]::before {
    background: linear-gradient(180deg, rgba(96, 165, 250, 0.75), rgba(96, 165, 250, 0.08));
  }

  &[data-direction="up"]::before {
    background: linear-gradient(180deg, rgba(255, 154, 61, 0.75), rgba(255, 154, 61, 0.08));
  }
...
export const NetworkingChannelHeader = styled.div`
  display: flex;
  align-items: center;
  gap: 8px;
  min-width: 0;
...
export const NetworkingChannelList = styled.div`
  display: grid;
  align-content: start;
  min-width: 0;
  min-height: 0;
...
export const NetworkingChannelRow = styled.article`
  display: grid;
...
export const NetworkingRowDot = styled.span`
  width: 7px;
  height: 7px;
  border-radius: 50%;
  background: #94a3b8;
...
export const NetworkingRowStatus = styled.span`
  flex: 0 0 auto;
  color: var(--forge-text-muted);
  font-size: 11px;
  font-weight: 780;
...
export const NetworkingRowCount = styled.span`
  display: inline-grid;
  min-width: 30px;
  height: 20px;
  place-items: center;
...
export const NetworkingRowMeter = styled.div`
  grid-column: 1 / -1;
  position: relative;
  width: 100%;
  height: 3px;
...
export const NetworkingActivity = styled.section`
  display: grid;
  grid-template-rows: auto minmax(0, 1fr);
  min-width: 0;
  min-height: 96px;
...
export const NetworkingActivityHeader = styled.div`
  display: flex;
  align-items: center;
  justify-content: space-between;
  gap: 10px;
...
export const NetworkingActivityList = styled.div`
  display: grid;
  align-content: start;
  min-width: 0;
  min-height: 0;
...
export const NetworkingActivityRow = styled.div`
  display: grid;
...
export const AgentInstallPanel = styled.div`
  ...
  gap: 8px;
  padding-top: 11px;
  border-top: 1px solid var(--settings-border-soft, var(--forge-border));
`;
...
export const AgentInstallCommand = styled.code`
  ...
  border-radius: 7px;
  color: var(--forge-text-muted);
  background: var(--settings-panel-bg-muted, rgba(7, 9, 13, 0.4));
...
export const WorkspaceCreateAgentPermission = styled.div`
...
export const WorkspaceCreateAgentPermissionLabel = styled.strong`
  min-width: 30px;
  max-width: 64px;
  overflow: hidden;
  color: var(--forge-text);
...
export const WorkspaceCreateCheckboxRow = styled.label`
  display: flex;
  align-items: flex-start;
  gap: 10px;
  max-width: 100%;
