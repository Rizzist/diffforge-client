...
/* xterm color themes — shared by the session terminal, the legacy pane
   host, and the detached terminal window. Living here keeps light hosts
   from importing the whole WorkspaceTerminal module for two constants. */
