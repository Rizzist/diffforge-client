...
export const MCP_CATALOG = [
  // --- Core agent utilities ------------------------------------------------
  {
    ...
    package_ref: "@modelcontextprotocol/server-filesystem",
    icon: null,
    env: [],
  },
  {
    ...
    package_ref: "@modelcontextprotocol/server-memory",
    icon: null,
    env: [],
  },
  {
    ...
    package_ref: "@modelcontextprotocol/server-fetch",
    icon: null,
    env: [],
  },
  {
    ...
    package_ref: "@modelcontextprotocol/server-sequential-thinking",
    icon: null,
    env: [],
  },
  {
    ...
    package_ref: "@wonderwhy-er/desktop-commander",
    icon: null,
    env: [],
  },
  ...
  },
  {
    ...
    package_ref: "@modelcontextprotocol/server-puppeteer",
    icon: Puppeteer,
    env: [],
  },
  {
    ...
    package_ref: "chrome-devtools-mcp",
    icon: Googlechrome,
    env: [],
  },
  {
  ...
  },
  {
    ...
    package_ref: "figma-developer-mcp",
    icon: Figma,
  ...
  // --- Docs, search & research ---------------------------------------------
  {
    ...
    package_ref: "@upstash/context7-mcp",
    icon: null,
    env: [],
  },
  {
  ...
  },
  {
    ...
    package_ref: "@modelcontextprotocol/server-brave-search",
    icon: Brave,
  ...
  },
  {
    ...
    package_ref: "server-perplexity-ask",
    icon: null,
  ...
  },
  {
    ...
    package_ref: "@apify/actors-mcp-server",
    icon: null,
  ...
  },
  {
    ...
    package_ref: "@kimtaeyoon83/mcp-server-youtube-transcript",
    icon: null,
    env: [],
  },
  ...
  // --- Code hosting & project tracking --------------------------------------
  {
    ...
    package_ref: "@modelcontextprotocol/server-github",
    icon: Github,
  ...
  },
  {
    ...
    package_ref: "@modelcontextprotocol/server-gitlab",
    icon: Gitlab,
    env: [
  ...
  },
  {
    ...
    package_ref: "@abhiz123/todoist-mcp-server",
    icon: Todoist,
  ...
  },
  {
    ...
    package_ref: "@notionhq/notion-mcp-server",
    icon: Notion,
  ...
  // --- Communication & CRM --------------------------------------------------
  {
    ...
    package_ref: "@modelcontextprotocol/server-slack",
    icon: Slack,
    env: [
  ...
  },
  {
    ...
    package_ref: "@hubspot/mcp-server",
    icon: Hubspot,
  ...
  // --- Databases & storage ----------------------------------------------------
  {
    ...
    package_ref: "@supabase/mcp-server-supabase",
    icon: Supabase,
  ...
  },
  {
    ...
    package_ref: "mongodb-mcp-server",
    icon: Mongodb,
  ...
  },
  {
    ...
    package_ref: "@benborla29/mcp-server-mysql",
    icon: Mysql,
    env: [
  ...
  },
  {
    ...
    package_ref: "@neondatabase/mcp-server-neon",
    icon: null,
  ...
  },
  {
    ...
    package_ref: "@pinecone-database/mcp",
    icon: null,
  ...
  },
  {
    ...
    package_ref: "@elastic/mcp-server-elasticsearch",
    icon: Elasticsearch,
    env: [
  ...
  },
  {
    ...
    package_ref: "airtable-mcp-server",
    icon: Airtable,
  ...
  // --- Cloud, hosting & ops ---------------------------------------------------
  {
    ...
    package_ref: "@cloudflare/mcp-server-cloudflare",
    icon: Cloudflare,
    env: [
  ...
  },
  {
    ...
    package_ref: "mcp-server-kubernetes",
    icon: Kubernetes,
    env: [],
  },
  {
  ...
  },
  {
    ...
    package_ref: "@circleci/mcp-server-circleci",
    icon: Circleci,
  ...
  },
  {
    ...
    package_ref: "@postman/postman-mcp-server",
    icon: Postman,
  ...
  },
  {
    ...
    package_ref: "@auth0/auth0-mcp-server",
    icon: Auth0,
    env: [],
  },
  ...
  // --- Maps & misc -------------------------------------------------------------
  {
    ...
    package_ref: "@modelcontextprotocol/server-google-maps",
    icon: Googlemaps,
  ...
  },
  {
    ...
    package_ref: "@coingecko/coingecko-mcp",
    icon: null,
    env: [],
  },
  {
