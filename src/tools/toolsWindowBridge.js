export const TOOLS_WINDOW_HASH = "#/tools-window";

export const TOOLS_WINDOW_META_EVENT = "forge-tools-window-meta";
...
export const TOOLS_WINDOW_CONTROL_DISCARD = "discard";
export const TOOLS_WINDOW_CONTROL_FOCUS_MAIN = "focus_main";
export const TOOLS_WINDOW_CONTROL_RETURN = "return";
export const TOOLS_WINDOW_CONTROL_RUN = "run";
